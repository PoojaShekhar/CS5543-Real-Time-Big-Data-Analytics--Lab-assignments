...
class ObjectMainDetection {
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("/home/poojashekhar/Downloads/RealTimeBigData/FeatureExtraction/Mercedes-Benz.mp4"));
        int count1 = 0, count2 = 0, count3 = 0;
        int k=0;


        String o1 = "/home/poojashekhar/Downloads/RealTimeBigData/Lab5/FeatureExtraction/output/features.txt";
        ...
        for (MBFImage mbfImage : video) {
            ...
            if (this.matcher1.findMatches(kpl) && ((MatrixTransformProvider) this.matcher1.getModel()).getTransform().cond() < 1e6 ) {
            ...
            String name = "/home/poojashekhar/Downloads/RealTimeBigData/Lab5/FeatureExtraction/output/modeldetectedframes/new_" + k + ".jpg";
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("/home/poojashekhar/Downloads/RealTimeBigData/FeatureExtraction/data/1.png"));
            modelImage2 = ImageUtilities.readMBF(new File("/home/poojashekhar/Downloads/RealTimeBigData/FeatureExtraction/data/2.png"));
            modelImage3 = ImageUtilities.readMBF(new File("/home/poojashekhar/Downloads/RealTimeBigData/FeatureExtraction/data/3.png"));
