...
/**
 * Created by poojashekhar on 11/24/16.
 */
public class ObjectTracking implements KeyListener, VideoDisplayListener<MBFImage>{
        ...
        VIDEO {
            ...
            public void render(final MBFImageRenderer renderer, final Matrix transform, final Rectangle rectangle) {
                if (this.toRender == null) {
                    ...
                    this.toRender =
                            new XuggleVideo(ObjectTracking.class
                                    .getResource("/home/poojashekhar/Downloads/RealTimeBigData/Lab3/src/main/java/org/openimaj/demos/video/"), true);
    ...
    private ObjectTracking.RenderMode renderMode = RenderMode.VIDEO;
     ...
     * @throws Exception
     */
    public ObjectTracking (final JComponent window) throws Exception {
        ...
        XuggleVideo xuggleVid = new XuggleVideo(ObjectTracking.class.getResource("/home/poojashekhar/Downloads/RealTimeBigData/Lab3/src/main/java/org/openimaj/demos/video/"), true);
    ...
    public synchronized void keyPressed(final KeyEvent key) {
        if (key.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            this.renderMode = ObjectTracking.RenderMode.SQUARE;
        } else if (key.getKeyChar() == '2') {
            this.renderMode = ObjectTracking.RenderMode.PICTURE;
        } else if (key.getKeyChar() == '3') {
            this.renderMode = ObjectTracking.RenderMode.VIDEO;
        }
    }
    ...
    public synchronized void afterUpdate(final VideoDisplay<MBFImage> display) {
        if (this.matcher != null && !this.videoFrame.isPaused()) {
                    ...
                    && ((MatrixTransformProvider) this.matcher.getModel()).getTransform().cond() < 1e6)
            {
                ...
                this.matchPanel.setBorder(BorderFactory.createTitledBorder("Matches - Found NewBorn"));
                renderer.drawText(new AttributedString("NewBorn"), 30, 70);
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final ObjectTracking od = new ObjectTracking(c);
