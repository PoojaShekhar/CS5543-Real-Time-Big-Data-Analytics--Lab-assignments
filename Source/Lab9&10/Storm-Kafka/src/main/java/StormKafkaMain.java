...
public class StormKafkaMain {
    private static final String KAFKA_TOPIC ="benz";
    ...
    private static StormTopology createTopology()
    {
        ...
        topology.setSpout("kafka_spout_videofeatures", new KafkaSpout(kafkaConf), 4);

//        topology.setBolt("DataExtraction", new DataExtractionBolt(), 4)
//                .shuffleGrouping("kafka_spout");
        topology.setBolt("ClassHome", new ClassHome(), 4)
                .shuffleGrouping("kafka_spout_videofeatures");

        topology.setBolt("ClassCar", new ClassCar(), 4)
                .shuffleGrouping("kafka_spout_videofeatures");

        topology.setBolt("ClassMan", new ClassMan(), 4)
                .shuffleGrouping("kafka_spout_videofeatures");
